  ...
  return (
    <Layout title='Groot' description='Groot Editor'>
      ...
      <div
        ...
        <h3>Latest release: 1.1.1 (2023-08-12)</h3>
        <div className={styles.downloadGroup}>
          <div id='card_download' style={{ textAlign: "center" }}>
            ...
            <Link
              ...
              to='https://s3.us-west-1.amazonaws.com/download.behaviortree.dev/groot2_windows_installer/Groot2-1.1.1-windows-installer.exe'>
              Windows installer
            </Link>
          </div>
          <div id='card_download' style={{ textAlign: "center" }}>
            ...
            <Link
              ...
              to='https://s3.us-west-1.amazonaws.com/download.behaviortree.dev/groot2_linux_installer/Groot2-1.1.1-linux-installer.run'>
              Linux installer
            </Link>
          </div>
          <div id='card_download' style={{ textAlign: "center" }}>
            ...
            <Link
              ...
              to='https://s3.us-west-1.amazonaws.com/download.behaviortree.dev/groot2_linux_installer/Groot2-v1.1.1-x86_64.AppImage'>
              AppImage (Linux)
            </Link>
          </div>
        </div>
